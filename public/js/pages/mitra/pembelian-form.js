jQuery(document).ready(function () {
    ...
    // selectMerk.append(defaultOpt);

    $("#field-merk").change(function(){
        produkPage = 1;
        getProduk(null, null, $(this).val() ,produkPage, 'filter');
    });
    ...
    list_produk.slimScroll().bind('slimscroll', function (e, pos) {
        ...
        {
            produkPage++;
	        getProduk(null, null, null,produkPage, 'page');
        }
        // console.log(pos);
    });
...
function getProduk(keyword, kategori_id, merk_id, page, tipe = 'page') {
    if(keyword == null)
    {
